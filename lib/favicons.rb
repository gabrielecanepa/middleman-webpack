def generate_favicons(icon)
  {
    icon => [
      { icon: 'images/apple-touch-icon-180x180-precomposed.png' },
      { icon: 'images/apple-touch-icon-152x152-precomposed.png' },
      { icon: 'images/apple-touch-icon-144x144-precomposed.png' },
      { icon: 'images/apple-touch-icon-120x120-precomposed.png' },
      { icon: 'images/apple-touch-icon-114x114-precomposed.png' },
      { icon: 'images/apple-touch-icon-76x76-precomposed.png' },
      { icon: 'images/apple-touch-icon-72x72-precomposed.png' },
      { icon: 'images/apple-touch-icon-60x60-precomposed.png' },
      { icon: 'images/apple-touch-icon-57x57-precomposed.png' },
      ...
      { icon: 'images/mstile-70x70.png', size: '70x70' }
    ]
  }
end
